...
/**
 * eGovFramework 의 Service 스테레오타입 클래스 모델 소스를 생성하는 자바 클래스
 * <p>
 * <b>NOTE:</b> Service 클래스 모델 템플릿.
 * 
 * @author 개발환경 개발팀 김형조
 * @since 2009.08.10
 * @version 1.0
 ...
 * </pre>
 */
public class TemplateService implements IGenerator {
	/** 개행 문자 */		
	 ...
	 * @return
	 */
	public static TemplateService create(String lineSeparator) {
		nl = lineSeparator;
		TemplateService result = new TemplateService();
		nl = null;
		return result;
	}
	/** 개행 문자 */	
