 ...
 * </pre>
 */
public class TemplateClass implements IGenerator {
	/** 개행 문자 */
	 ...
	 * @return
	 */
	public static TemplateClass create(String lineSeparator) {
		nl = lineSeparator;
		TemplateClass result = new TemplateClass();
		nl = null;
		return result;
	}

	/** 개행 문자 */
	public String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
	/** 템플릿 요소 1 */
	protected String TEXT_1 = NL + "/**" + NL + " * Description : " + NL + " * @author" + NL + " * @since" + NL + " * @version" + NL + " * @see" + NL + " *" + NL + " * <pre>" + NL
			+ " * << Modification Information >>" + NL + " *   " + NL + " *   Date     Modifier               Expression" + NL
			+ " *  -------    --------    ---------------------------" + NL + " *  " + NL + " *" + NL + " * " + NL + " * </pre>" + NL + " */";
	/** 템플릿 요소 2 */
	 ...
	 * (non-javadoc)
	 * 
	 * @see IGenerator#generatoe(Model)
	 */
	 ...
	 * 
	 * @see
	 * egovframework.dev.imp.codegen.model.generator.IGenerator#generate(java
	 * .lang.Object)
	 */
