...
import egovframework.dev.imp.codegen.model.converter.UML2NonEclipseModelConverter;
 ...
 * </pre>
 */
public class UML2SelectResourcePage extends WizardPage {

    /** 로거 */
    protected final Logger log = Logger.getLogger(UML2SelectResourcePage.class);
...
//	private CheckboxTreeViewer viewer;
	...
	protected UML2SelectResourcePage(String pageName) {
		super(pageName);
	...
	public void convertUmlModelFromXMI(String xmiFilePath) throws Exception{
		...
		if (XMIUtil.isEclipseUMLModel(doc)){
			...
			// 김연수 수정
			converter = new UML2NonEclipseModelConverter(); 
	...
	public IWizardPage getNextPage() {
    	...
    	UML2ModelBasedCodeGenWizardPage page = (UML2ModelBasedCodeGenWizardPage) super.getNextPage();
        if (convertOk){
