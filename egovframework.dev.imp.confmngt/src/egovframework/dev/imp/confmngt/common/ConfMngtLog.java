 ...
 */
package egovframework.dev.imp.confmngt.common;
...
public class ConfMngtLog {
    ...
    private static IStatus createStatus(int severity, int code, String message,
            Throwable exception) {
        IStatus status =
            new Status(severity, EgovConfMngtPlugin.PLUGIN_ID, code, message,
                exception);
        return status;
    }
    ...
    private static void log(IStatus status) {
    	EgovConfMngtPlugin.getDefault().getLog().log(status);
        return;
    }
