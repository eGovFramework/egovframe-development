...
/**
 * eGovFramework 의 Controller 스테레오타입 클래스 모델 소스를 생성하는 자바 클래스
 * <p>
 * <b>NOTE:</b> Controller 클래스 모델 템플릿
 * 
 * @author 개발환경 개발팀 김형조
 * @since 2009.08.10
 * @version 1.0
 ...
 * </pre>
 */
public class TemplateController implements IGenerator {
	/** 개행 문자 */
	 ...
	 * @return
	 */
	public static TemplateController create(String lineSeparator) {
		nl = lineSeparator;
		TemplateController result = new TemplateController();
		nl = null;
		return result;
	}
	...
	/** 템플릿 요소 4 */
	protected String TEXT_4 = NL + "\t@Resource(name = \"";
	/** 템플릿 요소 5 */
	protected String TEXT_5 = "\")" + NL + "    private ";
	/** 템플릿 요소 6 */
	protected String TEXT_6 = " ";
	/** 템플릿 요소 7 */
	protected String TEXT_7 = ";";
	/** 템플릿 요소 8 */
	protected String TEXT_8 = NL;
	/** 템플릿 요소 9 */
	protected String TEXT_9 = NL + "}";
	...
	public String generate(Object element) throws Exception {
		...
		GenUtil.addImportSyntax(iptList, "import org.springframework.stereotype.Controller;");
