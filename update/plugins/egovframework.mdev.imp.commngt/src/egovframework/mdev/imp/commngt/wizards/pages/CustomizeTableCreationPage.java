...
import egovframework.mdev.imp.commngt.util.CreateTableUtil;
import egovframework.mdev.imp.commngt.util.FindingScriptinZipUtil;
import egovframework.mdev.imp.commngt.util.HandlingPropertiesUtil;
import egovframework.mdev.imp.commngt.util.SettingSqlStatementUtil;
...
public class CustomizeTableCreationPage extends WizardPage {
	...
	public CustomizeTableCreationPage(String pageName,
			MobileCommngtContext context) {
		super(pageName);
		this.context = context;
		setTitle(MobileComMngtMessages.customizeTableCreationPagetitle);
	}
	...
	private void getJDBCInfo(){
		...
		if(isExist){
			dbType = EgovProperties.getProperty(HandlingPropertiesUtil.getFilePath(), MobileComMngtMessages.customizeTableCreationPage99); //$NON-NLS-1$
			driverClassName = EgovProperties.getProperty(HandlingPropertiesUtil.getFilePath(),MobileComMngtMessages.customizeTableCreationPage10);
			url = EgovProperties.getProperty(HandlingPropertiesUtil.getFilePath(),MobileComMngtMessages.customizeTableCreationPage19);
			username = EgovProperties.getProperty(HandlingPropertiesUtil.getFilePath(),MobileComMngtMessages.customizeTableCreationPage24);
			password = EgovProperties.getProperty(HandlingPropertiesUtil.getFilePath(),MobileComMngtMessages.customizeTableCreationPage29);
			...
			for (int i = 0; i < profileNames.length; i++) {
				...
				if(username.equals((String) profile.get(MobileComMngtMessages.customizeTableCreationPage68)) &&
						url.equals((String) profile.get(MobileComMngtMessages.customizeTableCreationPage65)) &&
						driverClassName.equals((String) profile.get(MobileComMngtMessages.customizeTableCreationPage53))){
					//화면에 뿌려줌
					
					selectedDatasourceNum = i;
					
					if (driverClassName.toLowerCase().indexOf(MobileComMngtMessages.customizeTableCreationPagedbType1) > -1) {
						dbType = MobileComMngtMessages.customizeTableCreationPagedbType1;
					} else if (driverClassName.toLowerCase().indexOf(MobileComMngtMessages.customizeTableCreationPagedbType2) > -1) {
						dbType = MobileComMngtMessages.customizeTableCreationPagedbType2;
					} else if (driverClassName.toLowerCase().indexOf(MobileComMngtMessages.customizeTableCreationPagedbType3) > -1) {
						dbType = MobileComMngtMessages.customizeTableCreationPagedbType3;
					} else if (driverClassName.toLowerCase().indexOf(MobileComMngtMessages.customizeTableCreationPagedbType4) > -1) {
						dbType = MobileComMngtMessages.customizeTableCreationPagedbType4;
					} else if (driverClassName.toLowerCase().indexOf(MobileComMngtMessages.customizeTableCreationPagedbType5) > -1) {
						dbType = MobileComMngtMessages.customizeTableCreationPagedbType5;
					} else{
						dbType = ""; //$NON-NLS-1$
					}
					...
					driverClassNameField.setText(NullUtil.isNone((String) profile.get(MobileComMngtMessages.customizeTableCreationPage53)) ? "" : (String) profile.get(MobileComMngtMessages.customizeTableCreationPage53)); //$NON-NLS-1$
					urlField.setText(NullUtil.isNone((String) profile.get(MobileComMngtMessages.customizeTableCreationPage65)) ? "" : (String) profile.get(MobileComMngtMessages.customizeTableCreationPage65)); //$NON-NLS-1$
					usernameField.setText(NullUtil.isNone((String) profile.get(MobileComMngtMessages.customizeTableCreationPage68)) ? "" : (String) profile.get(MobileComMngtMessages.customizeTableCreationPage68)); //$NON-NLS-1$
					passwordField.setText(NullUtil.isNone((String) profile.get(MobileComMngtMessages.customizeTableCreationPage71)) ? "" : (String) profile.get(MobileComMngtMessages.customizeTableCreationPage71)); //$NON-NLS-1$
					
				}else {
					setMessage(MobileComMngtMessages.customizeTableCreationPageDSEXPLORER, INFORMATION);
		...
		public void widgetSelected(SelectionEvent e) {
			...
			if (isConnect) {
				...
				MessageDialog.openInformation(getShell(),
						MobileComMngtMessages.customizeTableCreationPage47,
						MobileComMngtMessages.customizeTableCreationPage48);
			} else{
	...
	SelectionListener dbSelectionListener = new SelectionListener() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			String driverClass = (String) profile.get(MobileComMngtMessages.customizeTableCreationPage53);
			...
			//없을 경우 그냥 뿌려준다
			if (driverClass.toLowerCase().indexOf(MobileComMngtMessages.customizeTableCreationPagedbType1) > -1) {
				dbTypeCombo.setText(MobileComMngtMessages.customizeTableCreationPagedbType1);
				dbType = MobileComMngtMessages.customizeTableCreationPagedbType1;
			} else if (driverClass.toLowerCase().indexOf(MobileComMngtMessages.customizeTableCreationPagedbType2) > -1) {
				dbTypeCombo.setText(MobileComMngtMessages.customizeTableCreationPagedbType2);
				dbType = MobileComMngtMessages.customizeTableCreationPagedbType2;
			} else if (driverClass.toLowerCase().indexOf(MobileComMngtMessages.customizeTableCreationPagedbType3) > -1) {
				dbTypeCombo.setText(MobileComMngtMessages.customizeTableCreationPagedbType3);
				dbType = MobileComMngtMessages.customizeTableCreationPagedbType3;
			} else if (driverClass.toLowerCase().indexOf(MobileComMngtMessages.customizeTableCreationPagedbType4) > -1) {
				dbTypeCombo.setText(MobileComMngtMessages.customizeTableCreationPagedbType4);
				dbType = MobileComMngtMessages.customizeTableCreationPagedbType4;
			} else if (driverClass.toLowerCase().indexOf(MobileComMngtMessages.customizeTableCreationPagedbType5) > -1) {
				dbTypeCombo.setText(MobileComMngtMessages.customizeTableCreationPagedbType5);
				dbType = MobileComMngtMessages.customizeTableCreationPagedbType5;
			} else{
				dbTypeCombo.setText(""); //$NON-NLS-1$
				dbType = ""; //$NON-NLS-1$
				setErrorMessage(MobileComMngtMessages.customizeTableCreationPageDatasourceError);
				connectionBtn.setEnabled(false);
			}
					
			if (NullUtil.isNone((String) profile.get(MobileComMngtMessages.customizeTableCreationPage65))) {
				urlField.setText(""); //$NON-NLS-1$
			} else {
				
				urlField.setText((String) profile.get(MobileComMngtMessages.customizeTableCreationPage65));
			}
					
			if (NullUtil.isNone((String) profile.get(MobileComMngtMessages.customizeTableCreationPage68))) {
				usernameField.setText(""); //$NON-NLS-1$
			} else {
				usernameField.setText((String) profile.get(MobileComMngtMessages.customizeTableCreationPage68));
			}
					
			if (NullUtil.isNone((String) profile.get(MobileComMngtMessages.customizeTableCreationPage71))) {
				passwordField.setText(""); //$NON-NLS-1$
			} else {
				passwordField.setText((String) profile.get(MobileComMngtMessages.customizeTableCreationPage71));
			}
			...
			try {
				...
				getContainer().run(true, true, new IRunnableWithProgress() {
					...
					public void run(IProgressMonitor monitor)
						...
						monitor.beginTask(
								MobileComMngtMessages.customizeTableCreationPage96,
						...
						for (int i = 0; i < checkedComponent.size(); i++) {
							...
							fileName = MobileComMngtMessages.customizeTableCreationPage38
									+ checkedComponent.get(i).getFileName();

							if (checkedComponent.get(i).getUseTable().length() != 0) {

								monitor.subTask(MobileComMngtMessages.customizeTableCreationPage97);
								monitor.worked(1);
								...
								if (!haMap.isEmpty()) {
									...
									// 나눠서 각각 넣는다
									ddlContents = haMap
											.get(MobileComMngtMessages.customizeTableCreationPage39);

									if (haMap
											.get(MobileComMngtMessages.customizeTableCreationPage40) != null) {
										dmlContents = haMap
												.get(MobileComMngtMessages.customizeTableCreationPage40);
									}

									monitor.subTask(MobileComMngtMessages.customizeTableCreationPage98);
									monitor.worked(1);
						...
						for (int i = 0; i < innerModel.size(); i++) {
							...
							if(innerModel.get(i).getComponent() != null && !innerModel.get(i).getStmtType().equalsIgnoreCase(MobileComMngtMessages.customizeTableCreationPageindex)) {
				...
				if (innerModel.size() == 0) {
					setErrorMessage(null);
					setErrorMessage(MobileComMngtMessages.customizeTableCreationPage100);
				}
				...
				if(!NullUtil.isNone(innerModel.get(0).getResultMessage())){
					...
					if (innerModel.get(0).getResultMessage()
							.indexOf(MobileComMngtMessages.customizeTableCreationPagebefore) < 0) {
						// 테이블 생성이 정상 종료된 경우
						successCreate = true;
					}
				}
	...
	private void selectDbCombo(Composite parent) {
		...
		selectDBLb.setText(MobileComMngtMessages.customizeTableCreationPage2);
	...
	private void insertDatasourceGrp(Composite parent) {
		...
		descriptionGrp
				.setText(MobileComMngtMessages.customizeTableCreationPage3);
		...
		dbTypeLabel.setText(MobileComMngtMessages.customizeTableCreationPage4);
		...
		String items[] = {
				MobileComMngtMessages.customizeTableCreationPagedbType1,
				MobileComMngtMessages.customizeTableCreationPagedbType2,
				MobileComMngtMessages.customizeTableCreationPagedbType3,
				MobileComMngtMessages.customizeTableCreationPagedbType4,
				MobileComMngtMessages.customizeTableCreationPagedbType5,
				""}; //$NON-NLS-1$
		...
		driverClassNameLabel.setText(MobileComMngtMessages.customizeTableCreationPage13);
		...
		urlLabel.setText(MobileComMngtMessages.customizeTableCreationPage18);
		...
		usernameLabel
				.setText(MobileComMngtMessages.customizeTableCreationPage23);
		...
		passwordLabel
				.setText(MobileComMngtMessages.customizeTableCreationPage28);
		...
		connectionBtn.setEnabled(false);
		connectionBtn.setText(MobileComMngtMessages.customizeTableCreationPage32);
		...
		createTableBtn.setEnabled(false);
		createTableBtn.setText(MobileComMngtMessages.customizeTableCreationPage33);
	...
	private void createGrp(Composite parent) {
		...
		descriptionGrp
				.setText(MobileComMngtMessages.customizeTableCreationPage33);
		...
		col1.setText(MobileComMngtMessages.customizeTableCreationPage35);
		col1.setWidth(170);
		TableColumn col2 = new TableColumn(viewer.getTable(), SWT.NONE);
		col2.setText(MobileComMngtMessages.customizeTableCreationPage36);
		col2.setWidth(120);
		TableColumn col3 = new TableColumn(viewer.getTable(), SWT.NONE);
		col3.setText(MobileComMngtMessages.customizeTableCreationPage37);
		col3.setWidth(160);
	...
	public void performOk(IProgressMonitor monitor) {
		monitor.beginTask(MobileComMngtMessages.customizeTableCreationPage74, 1);
	...
	public void setVisible(boolean visible) {
		...
		if (visible) {
			...
			checkLastPage = MobileComMngtMessages.customizeTableCreationPage75;
			...
			if (selectDBCombo.getItems().length == 0) {
				setMessage(MobileComMngtMessages.customizeTableCreationPage76, SWT.BOLD);
			...
			if (globalsFile == null) {
				...
				if (globalsFile.getName().indexOf(MobileComMngtMessages.customizeTableCreationPage2) >= 0) {
					isExist = true;
				}
			}
			...
			if (globalsFileRe == null) {
				...
				if (globalsFile.getName().indexOf(MobileComMngtMessages.customizeTableCreationPage1) >= 0) {
					isExist = true;
				}
			}
