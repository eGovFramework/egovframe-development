...
public class NewBatchJob extends AbstractHandler implements EgovBatchMenu {
	/**
	 * 잡 생성 마법사
	 */
	public Object execute(ExecutionEvent event) throws ExecutionException {
		IWizardDescriptor wizardDesc = WorkbenchPlugin.getDefault().getNewWizardRegistry().findWizard("egovframework.bdev.imp.batch.wizards.NewBatchJobWizard");
