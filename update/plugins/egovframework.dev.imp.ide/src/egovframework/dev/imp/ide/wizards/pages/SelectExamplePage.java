...
public class SelectExamplePage extends WizardPage {
    ...
    public SelectExamplePage(String pageName, NewProjectContext context) {
        ...
        setTitle(IdeMessages.wizardspagesSelectSamplePage0);
        setDescription(IdeMessages.wizardspagesSelectSamplePage1);
    }
    ...
    private void createSelection(Composite parent) {
        ...
        createExampleButton
            .setText(IdeMessages.wizardspagesSelectSamplePage2);
    ...
    private void createEntryLIst(Composite parent) {
        ...
        group.setText(IdeMessages.wizardspagesSelectSamplePage3);
        group.setSize(0, 400);
    ...
    class SourceItemLabelProvider extends LabelProvider implements
        ...
        public Image getColumnImage(Object element, int columnIndex) {
            if (columnIndex == 0)
                return EgovIdePlugin.getDefault().getImage(
                    EgovIdePlugin.IMG_ITEM);
            else
                return null;
        }
