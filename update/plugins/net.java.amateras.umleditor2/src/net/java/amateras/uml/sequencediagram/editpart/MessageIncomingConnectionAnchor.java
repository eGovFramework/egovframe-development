 ...
 *
 */
public class MessageIncomingConnectionAnchor extends AbstractConnectionAnchor {

	private AbstractUMLEntityModel relation;
	
	
	public MessageIncomingConnectionAnchor(IFigure owner, AbstractUMLEntityModel relation) {
		super(owner);
