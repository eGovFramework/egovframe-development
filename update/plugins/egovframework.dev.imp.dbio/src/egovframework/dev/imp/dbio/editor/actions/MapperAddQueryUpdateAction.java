 ...
 * </pre>
 */
public class MapperAddQueryUpdateAction extends MapperAddElementAction {
	 ...
	 * @param viewer
	 */
	public MapperAddQueryUpdateAction(MapperPage page, StructuredViewer viewer) {
		super(viewer, "Add Update Query");
		this.setPage(page);
	}
	...
	protected MapperElement createNewElement(Element root) {
		...
		String tagName = "update"; //$NON-NLS-1$
