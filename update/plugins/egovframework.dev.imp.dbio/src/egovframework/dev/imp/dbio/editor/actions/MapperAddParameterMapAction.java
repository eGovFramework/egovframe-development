 ...
 * </pre>
 */
public class MapperAddParameterMapAction extends MapperAddElementAction{
//public class MapperAddParameterMapAction extends MapperAddElementAction implements MapperAddParameterMap{//이벤트 미처리로 MapperAddParameterMap 인터페이스를 뺀다. 
	private MapperPage page;
	/**
	 * 생성자
	 * @param viewer
	 */
	public MapperAddParameterMapAction(MapperPage page, TreeViewer viewer) {
	...
	protected MapperElement createNewElement(Element root) {
		MapperParameterMapElement newElement = 
			new MapperParameterMapElement(root.getOwnerDocument().createElement("parameterMap"), //$NON-NLS-1$
					getGroups()[MapperMasterPart.PARAMETER_GROUP]);
