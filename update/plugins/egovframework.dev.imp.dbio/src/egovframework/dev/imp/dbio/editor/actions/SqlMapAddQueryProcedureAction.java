 ...
 * </pre>
 */
public class SqlMapAddQueryProcedureAction extends SqlMapAddElementAction {
	 ...
	 * @param viewer
	 */
	public SqlMapAddQueryProcedureAction(SqlMapPage page, StructuredViewer viewer) {
		super(viewer, "Add Procedure");
		this.setPage(page);
	}
	...
	protected SqlMapElement createNewElement(Element root) {
		String sql = "{call procedure_name(p1, p2)}";
		
		String tagName = "procedure"; //$NON-NLS-1$
