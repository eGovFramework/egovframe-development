 ...
 * </pre>
 */
public class MapperCacheModelDetailsPart extends AbstractDetailsPage {
	...
	private MapperCacheModelElement currentElement;
	...
	public MapperCacheModelDetailsPart(MapperMasterPart masterPart) {
		super();
	 ...
	 * @return
	 */
//	private List<Element> createCacheModel(MapperCacheModelElement element) {
...
//	}
	...
	protected void selectionChanged(IStructuredSelection selection) {
		...
		if (element instanceof MapperCacheModelElement) {
			currentElement = (MapperCacheModelElement) element;
			refresh();
		} else {
			currentElement = null;
		}
