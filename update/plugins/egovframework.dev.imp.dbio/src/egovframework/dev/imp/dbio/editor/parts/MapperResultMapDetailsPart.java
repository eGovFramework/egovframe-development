 ...
 * </pre>
 */
public class MapperResultMapDetailsPart extends AbstractDetailsPage {

	private MapperMasterPart masterPart;
	
	private TextField idField;
	private ComboEditField classField; //ComboField -> ComboEditField
	private TableViewer viewer;
	
	private boolean refreshing = false;
	private MapperResultMapElement currentElement;
	 ...
	 * @param masterPart
	 */
	public MapperResultMapDetailsPart(MapperMasterPart masterPart) {
		super();
	...
	private void setClassField() {
		this.classField = new HyperLinkComboEditButtonField("Type*:", "Browse"); //ComboField -> ComboEditField : new : HyperLinkComboButtonField -> HyperLinkComboEditButtonField
	}
	...
	public void refresh() {
		...
		try {
			...
			String classText = StringUtil.nvl(currentElement.getClassName());
			if("".equals(classText)) {
				classText = DbioMessages.mapper_display_Type_guide;
			}
...
//			table.setSize(area.width-96, area.height);
	...
	private List<Element> createResult(MapperResultMapElement element) {
	...
	protected void selectionChanged(IStructuredSelection selection) {
		...
		if (element instanceof MapperResultMapElement) {
			currentElement = (MapperResultMapElement) element;
		} else {
			currentElement = null;
		}
		refresh();
