...
/**
 * SqlMap 에디터의 ParameterMap 상세부 화면
 * @author 개발환경 개발팀 김형조
 * @since 2009.02.20
 * @version 1.0
 * @see
 ...
 * </pre>
 */
public class SqlMapParameterMapDetailsPart extends AbstractDetailsPage {
...
//	};
	...
	private SqlMapParameterMapElement currentElement;
	...
	public SqlMapParameterMapDetailsPart(SqlMapMasterPart masterPart) {
		super();
...
//			new TableComboBoxCellEditor(viewer, 2, JDBCTYPES, SWT.READ_ONLY)
	...
	private List<Element> createParameter(SqlMapParameterMapElement element) {
	...
	protected void selectionChanged(IStructuredSelection selection) {
		...
		if (element instanceof SqlMapParameterMapElement) {
			currentElement = (SqlMapParameterMapElement) element;
			refresh();
		} else {
			currentElement = null;
		}
