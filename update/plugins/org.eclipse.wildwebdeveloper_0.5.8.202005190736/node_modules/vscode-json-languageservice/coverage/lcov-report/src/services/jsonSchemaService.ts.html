...
<head>
    <title>Code coverage report for src/services/jsonSchemaService.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/services</a> jsonSchemaService.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">92.33% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>325/352</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>127/156</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>290/314</span>
            </div>
...
<a name='L606'></a><a href='#L606'>606</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1133x</span>
<span class="cline-any cline-yes">1133x</span>
<span class="cline-any cline-yes">1133x</span>
<span class="cline-any cline-yes">1133x</span>
<span class="cline-any cline-yes">1104x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2246x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1365x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-yes">743x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-yes">240x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">19530x</span>
<span class="cline-any cline-yes">15624x</span>
<span class="cline-any cline-yes">15624x</span>
<span class="cline-any cline-yes">151x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11718x</span>
<span class="cline-any cline-yes">7812x</span>
<span class="cline-any cline-yes">7812x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1253x</span>
<span class="cline-any cline-yes">1253x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
	constructor(pattern: string[], uris: string[]) {
		...
		try {
			...
			// invalid pattern
<span class="cstat-no" title="statement not covered" >			this.patternRegExps.length = 0;</span>
<span class="cstat-no" title="statement not covered" >			this.isInclude.length = 0;</span>
<span class="cstat-no" title="statement not covered" >			this.uris = [];</span>
		}
&nbsp;
	}
&nbsp;
...
export class ResolvedSchema {
	...
	public errors: string[];
&nbsp;
	constructor(schema: JSONSchema, <span class="missing-if-branch" title="if path not taken" >I</span>errors: string[] = []) {
		this.schema = schema;
		this.errors = errors;
	}
&nbsp;
...
&nbsp;
		...
		} else <span class="missing-if-branch" title="if path not taken" >I</span>if (schema.patternProperties) {
<span class="cstat-no" title="statement not covered" >			for (const pattern<span class="cstat-no" title="statement not covered" > of <span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >O</span>bject.</span>keys(schema.patternProperties))</span> {</span>
				const regex = <span class="cstat-no" title="statement not covered" >new RegExp(pattern);</span>
<span class="cstat-no" title="statement not covered" >				if (regex.test(next)) {</span>
<span class="cstat-no" title="statement not covered" >					return this.getSectionRecursive(path, schema.patternProperties[pattern]);</span>
				}
			}
		} else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.additionalProperties === 'object') {
<span class="cstat-no" title="statement not covered" >			return this.getSectionRecursive(path, schema.additionalProperties);</span>
		} else if (next.match('[0-9]+')) {
			<span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(schema.items)) {
				const index = <span class="cstat-no" title="statement not covered" >parseInt(next, 10);</span>
<span class="cstat-no" title="statement not covered" >				if (!isNaN(index) &amp;&amp; schema.items[index]) {</span>
<span class="cstat-no" title="statement not covered" >					return this.getSectionRecursive(path, schema.items[index]);</span>
				}
			} else <span class="missing-if-branch" title="else path not taken" >E</span>if (schema.items) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >	public d</span>ispose(): void {
<span class="cstat-no" title="statement not covered" >		while (this.callOnDispose.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >			this.callOnDispose.pop()!();</span>
		}
	}
&nbsp;
...
&nbsp;
	public setSchemaContributions(schemaContributions: ISchemaContributions): void {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (schemaContributions.schemas) {
...
&nbsp;
		...
		return unresolvedSchemaContent ? this.addSchemaHandle(id, unresolvedSchemaContent) : <span class="branch-1 cbranch-no" title="branch not covered" >this.getOrAddSchemaHandle(id);</span>
	}
&nbsp;
...
&nbsp;
	public getResolvedSchema(schemaId: string): Thenable&lt;ResolvedSchema | undefined&gt; {
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (schemaHandle) {
			return schemaHandle.getResolvedSchema();
		}
<span class="cstat-no" title="statement not covered" >		return this.promise.resolve(undefined);</span>
	}
&nbsp;
		...
		return this.requestService(url).then(
			content =&gt; {
				<span class="missing-if-branch" title="if path not taken" >I</span>if (!content) {
					const errorMessage = <span class="cstat-no" title="statement not covered" >localize('json.schema.nocontent', 'Unable to load schema from \'{0}\': No content.', toDisplayString(url));</span>
<span class="cstat-no" title="statement not covered" >					return new UnresolvedSchema(&lt;JSONSchema&gt;{}, [errorMessage]);</span>
				}
&nbsp;
				let schemaContent: JSONSchema = {};
				const jsonErrors: Json.ParseError[] = [];
				schemaContent = Json.parse(content, jsonErrors);
				const errors = jsonErrors.length ? <span class="branch-0 cbranch-no" title="branch not covered" >[localize('json.schema.invalidFormat', 'Unable to parse content from \'{0}\': Parse error at offset {1}.', toDisplayString(url), jsonErrors[0].offset)] </span>: [];
				return new UnresolvedSchema(schemaContent, errors);
			},
			(error: any) =&gt; {
				let errorMessage = error.toString() as string;
				const errorSplit = error.toString().split('Error: ');
				<span class="missing-if-branch" title="if path not taken" >I</span>if (errorSplit.length &gt; 1) {
					// more concise error message, URL and context are attached by caller anyways
<span class="cstat-no" title="statement not covered" >					errorMessage = errorSplit[1];</span>
				}
				<span class="missing-if-branch" title="if path not taken" >I</span>if (Strings.endsWith(errorMessage, '.')) {
<span class="cstat-no" title="statement not covered" >					errorMessage = errorMessage.substr(0, errorMessage.length - 1);</span>
				}
...
&nbsp;
		if (schema.$schema) {
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if (id === 'http://json-schema.org/draft-03/schema') {
<span class="cstat-no" title="statement not covered" >				return this.promise.resolve(new ResolvedSchema({}, [localize('json.schema.draft03.notsupported', "Draft-03 schemas are not supported.")]));</span>
			} else <span class="missing-if-branch" title="if path not taken" >I</span>if (id === 'https://json-schema.org/draft/2019-09/schema') {
<span class="cstat-no" title="statement not covered" >				schemaToResolve.errors.push(localize('json.schema.draft201909.notsupported', "Draft 2019-09 schemas are not yet fully supported."));</span>
			}
		}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >				resolveErrors.push(localize('json.schema.invalidref', '$ref \'{0}\' in \'{1}\' can not be resolved.', path, sourceURI));</span>
			}
		};
&nbsp;
		const resolveExternalLink = (node: JSONSchema, uri: string, refSegment: string | undefined, parentSchemaURL: string, parentSchemaDependencies: SchemaDependencies): Thenable&lt;any&gt; =&gt; {
			...
			return referencedHandle.getUnresolvedSchema().then(unresolvedSchema =&gt; {
				...
				if (unresolvedSchema.errors.length) {
					const loc = refSegment ? <span class="branch-0 cbranch-no" title="branch not covered" >uri + '#' + refSegment </span>: uri;
...
&nbsp;
		const resolveRefs = (node: JSONSchema, parentSchema: JSONSchema, parentSchemaURL: string, parentSchemaDependencies: SchemaDependencies): Thenable&lt;any&gt; =&gt; {
			<span class="missing-if-branch" title="if path not taken" >I</span>if (!node || typeof node !== 'object') {
				...
				for (const map of maps) {
					if (typeof map === 'object') {
						for (const k in map) {
							...
							const entry = map[key];
							<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof entry === 'object') {
								toWalk.push(entry);
							}
						}
					}
...
&nbsp;
		...
		if (document &amp;&amp; document.root &amp;&amp; document.root.type === 'object') {
			...
			if (schemaProperties.length &gt; 0) {
				...
				<span class="missing-if-branch" title="else path not taken" >E</span>if (valueNode &amp;&amp; valueNode.type === 'string') {
					let schemeId = &lt;string&gt;Parser.getNodeValue(valueNode);
					<span class="missing-if-branch" title="if path not taken" >I</span>if (schemeId &amp;&amp; Strings.startsWith(schemeId, '.') &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >this.contextService)</span> {
<span class="cstat-no" title="statement not covered" >						schemeId = this.contextService.resolveRelativePath(schemeId, resource);</span>
					}
					if (schemeId) {
		...
		for (const entry of this.filePatternAssociations) {
			if (entry.matchesPattern(resource)) {
				for (const schemaId of entry.getURIs()) {
					<span class="missing-if-branch" title="else path not taken" >E</span>if (!seen[schemaId]) {
