...
<head>
    <title>Code coverage report for src/services/jsonCompletion.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/services</a> jsonCompletion.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">84.57% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>433/512</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>341/440</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">84.23% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>406/482</span>
            </div>
...
<a name='L922'></a><a href='#L922'>922</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
	constructor(
		...
		private <span class="missing-if-branch" title="else path not taken" >E</span>contributions: JSONWorkerContribution[] = [],
		private <span class="missing-if-branch" title="if path not taken" >I</span>promiseConstructor: PromiseConstructor = Promise,
		private clientCapabilities: ClientCapabilities = {}) {
	}
&nbsp;
<span class="fstat-no" title="function not covered" >	public d</span>oResolve(item: CompletionItem): Thenable&lt;CompletionItem&gt; {
<span class="cstat-no" title="statement not covered" >		for (let i = <span class="cstat-no" title="statement not covered" >this.contributions.length - 1;</span> i &gt;= 0; i--) {</span>
			const resolveCompletion = <span class="cstat-no" title="statement not covered" >this.contributions[i].resolveCompletion;</span>
<span class="cstat-no" title="statement not covered" >			if (resolveCompletion) {</span>
				const resolver = <span class="cstat-no" title="statement not covered" >resolveCompletion(item);</span>
<span class="cstat-no" title="statement not covered" >				if (resolver) {</span>
<span class="cstat-no" title="statement not covered" >					return resolver;</span>
				}
			}
		}
<span class="cstat-no" title="statement not covered" >		return this.promiseConstructor.resolve(item);</span>
	}
&nbsp;
...
&nbsp;
		if (node &amp;&amp; (node.type === 'string' || node.type === 'number' || node.type === 'boolean' || node.type === 'null')) {
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if (overwriteStart &gt; 0 &amp;&amp; text[overwriteStart - 1] === '"') {
<span class="cstat-no" title="statement not covered" >				overwriteStart--;</span>
			}
		...
		const collector: CompletionsCollector = {
			add: (suggestion: CompletionItem) =&gt; {
				...
				if (!existing) {
					...
					<span class="missing-if-branch" title="else path not taken" >E</span>if (overwriteRange &amp;&amp; suggestion.insertText !== undefined) {
						suggestion.textEdit = TextEdit.replace(overwriteRange, suggestion.insertText);
					}
					<span class="missing-if-branch" title="if path not taken" >I</span>if (supportsCommitCharacters) {
<span class="cstat-no" title="statement not covered" >						suggestion.commitCharacters = suggestion.kind === CompletionItemKind.Property ? propertyCommitCharacters : valueCommitCharacters;</span>
					}
					suggestion.label = label;
					proposed[label] = suggestion;
					result.items.push(suggestion);
				} else <span class="missing-if-branch" title="else path not taken" >E</span>if (!existing.documentation) {
					existing.documentation = suggestion.documentation;
				}
			},
			setAsIncomplete: <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >				result.isIncomplete = true;</span>
			},
			error: <span class="fstat-no" title="function not covered" >(m</span>essage: string) =&gt; {
<span class="cstat-no" title="statement not covered" >				console.error(message);</span>
			},
			log: <span class="fstat-no" title="function not covered" >(m</span>essage: string) =&gt; {
...
&nbsp;
			...
			if (node &amp;&amp; node.type === 'object') {
				...
				<span class="missing-if-branch" title="if path not taken" >I</span>if (node.offset === offset) {
...
&nbsp;
				...
				this.contributions.forEach(<span class="fstat-no" title="function not covered" >(c</span>ontribution) =&gt; {
					const collectPromise = <span class="cstat-no" title="statement not covered" >contribution.collectPropertyCompletions(document.uri, location, currentWord, addValue, separatorAfter === '', collector);</span>
<span class="cstat-no" title="statement not covered" >					if (collectPromise) {</span>
<span class="cstat-no" title="statement not covered" >						collectionPromises.push(collectPromise);</span>
					}
				});
				<span class="missing-if-branch" title="if path not taken" >I</span>if ((!schema &amp;&amp; currentWord.length &gt; 0 &amp;&amp; text.charAt(offset - currentWord.length - 1) !== '"')) {
<span class="cstat-no" title="statement not covered" >					collector.add({</span>
						kind: CompletionItemKind.Property,
						label: this.getLabelForValue(currentWord),
						insertText: this.getInsertTextForProperty(currentWord, undefined, false, separatorAfter),
						insertTextFormat: InsertTextFormat.Snippet, documentation: '',
					});
<span class="cstat-no" title="statement not covered" >					collector.setAsIncomplete();</span>
				}
			}
&nbsp;
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if (this.contributions.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >				this.getContributedValueCompletions(doc, node, offset, document, collector, collectionPromises);</span>
			}
&nbsp;
			return this.promiseConstructor.all(collectionPromises).then(() =&gt; {
				if (collector.getNumberOfProposals() === 0) {
					let offsetForSeparator = offset;
					<span class="missing-if-branch" title="if path not taken" >I</span>if (node &amp;&amp; (node.type === 'string' || node.type === 'number' || node.type === 'boolean' || node.type === 'null')) {
<span class="cstat-no" title="statement not covered" >						offsetForSeparator = node.offset + node.length;</span>
					}
...
&nbsp;
	private getSchemaLessPropertyCompletions(doc: Parser.JSONDocument, node: ASTNode, currentKey: string, collector: CompletionsCollector): void {
		...
		if (node.parent) {
			...
			} else <span class="missing-if-branch" title="else path not taken" >E</span>if (node.parent.type === 'array') {
		...
		} else <span class="missing-if-branch" title="else path not taken" >E</span>if (node.type === 'object') {
			collector.add({
				kind: CompletionItemKind.Property,
				label: '$schema',
...
&nbsp;
		if (node.type === 'property') {
			<span class="missing-if-branch" title="else path not taken" >E</span>if (offset &gt; (node.colonOffset || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>) {
&nbsp;
				const valueNode = node.valueNode;
				<span class="missing-if-branch" title="if path not taken" >I</span>if (valueNode &amp;&amp; (offset &gt; (valueNode.offset + valueNode.length) || valueNode.type === 'object' || valueNode.type === 'array')) {
<span class="cstat-no" title="statement not covered" >					return;</span>
				}
				...
				<span class="missing-if-branch" title="if path not taken" >I</span>if (parentKey === '$schema' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >node.parent </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >!node.parent.parent)</span> {
<span class="cstat-no" title="statement not covered" >					this.addDollarSchemaCompletions(separatorAfter, collector);</span>
				}
			}
		}
		<span class="missing-if-branch" title="if path not taken" >I</span>if (node.type === 'array') {
<span class="cstat-no" title="statement not covered" >			if (node.parent &amp;&amp; node.parent.type === 'property') {</span>
&nbsp;
				// suggest items of an array at the same key
				const parentKey = <span class="cstat-no" title="statement not covered" >node.parent.keyNode.value;</span>
<span class="cstat-no" title="statement not covered" >				doc.visit(<span class="fstat-no" title="function not covered" >(n</span>) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >					if (n.type === 'property' &amp;&amp; n.keyNode.value === parentKey &amp;&amp; n.valueNode &amp;&amp; n.valueNode.type === 'array') {</span>
<span class="cstat-no" title="statement not covered" >						n.valueNode.items.forEach(collectSuggestionsForValues);</span>
					}
<span class="cstat-no" title="statement not covered" >					return true;</span>
				});
			} else {
				// suggest items in the same array
<span class="cstat-no" title="statement not covered" >				node.items.forEach(collectSuggestionsForValues);</span>
			}
		}
	}
&nbsp;
...
&nbsp;
		if ((node.type === 'property') &amp;&amp; offset &gt; (node.colonOffset || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>) {
			const valueNode = node.valueNode;
			<span class="missing-if-branch" title="if path not taken" >I</span>if (valueNode &amp;&amp; offset &gt; (valueNode.offset + valueNode.length)) {
<span class="cstat-no" title="statement not covered" >				return; </span>// we are past the value node
			}
				...
				if (s.node === node &amp;&amp; !s.inverted &amp;&amp; s.schema) {
					if (node.type === 'array' &amp;&amp; s.schema.items) {
						if (Array.isArray(s.schema.items)) {
							...
							<span class="missing-if-branch" title="else path not taken" >E</span>if (index &lt; s.schema.items.length) {
					...
					if (s.schema.properties &amp;&amp; parentKey !== undefined) {
						...
						<span class="missing-if-branch" title="else path not taken" >E</span>if (propertySchema) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >	private g</span>etContributedValueCompletions(doc: Parser.JSONDocument, node: ASTNode | undefined, offset: number, document: TextDocument, collector: CompletionsCollector, collectionPromises: Thenable&lt;any&gt;[]) {
<span class="cstat-no" title="statement not covered" >		if (!node) {</span>
<span class="cstat-no" title="statement not covered" >			this.contributions.forEach(<span class="fstat-no" title="function not covered" >(c</span>ontribution) =&gt; {</span>
				const collectPromise = <span class="cstat-no" title="statement not covered" >contribution.collectDefaultCompletions(document.uri, collector);</span>
<span class="cstat-no" title="statement not covered" >				if (collectPromise) {</span>
<span class="cstat-no" title="statement not covered" >					collectionPromises.push(collectPromise);</span>
				}
			});
		} else {
<span class="cstat-no" title="statement not covered" >			if (node.type === 'string' || node.type === 'number' || node.type === 'boolean' || node.type === 'null') {</span>
<span class="cstat-no" title="statement not covered" >				node = node.parent;</span>
			}
<span class="cstat-no" title="statement not covered" >			if (node &amp;&amp; (node.type === 'property') &amp;&amp; offset &gt; (node.colonOffset || 0)) {</span>
				const parentKey = <span class="cstat-no" title="statement not covered" >node.keyNode.value;</span>
&nbsp;
				const valueNode = <span class="cstat-no" title="statement not covered" >node.valueNode;</span>
<span class="cstat-no" title="statement not covered" >				if ((!valueNode || offset &lt;= (valueNode.offset + valueNode.length)) &amp;&amp; node.parent) {</span>
					const location = <span class="cstat-no" title="statement not covered" >Parser.getNodePath(node.parent);</span>
<span class="cstat-no" title="statement not covered" >					this.contributions.forEach(<span class="fstat-no" title="function not covered" >(c</span>ontribution) =&gt; {</span>
						const collectPromise = <span class="cstat-no" title="statement not covered" >contribution.collectValueCompletions(document.uri, location, parentKey, collector);</span>
<span class="cstat-no" title="statement not covered" >						if (collectPromise) {</span>
<span class="cstat-no" title="statement not covered" >							collectionPromises.push(collectPromise);</span>
						}
					});
...
&nbsp;
	private addSchemaValueCompletions(schema: JSONSchemaRef, separatorAfter: string, collector: CompletionsCollector, types: { [type: string]: boolean }): void {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof schema === 'object') {
			this.addEnumValueCompletions(schema, separatorAfter, collector);
			this.addDefaultValueCompletions(schema, separatorAfter, collector);
			this.collectTypes(schema, types);
			<span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(schema.allOf)) {
<span class="cstat-no" title="statement not covered" >				schema.allOf.forEach(<span class="fstat-no" title="function not covered" >s </span>=&gt; <span class="cstat-no" title="statement not covered" >this.addSchemaValueCompletions(s, separatorAfter, collector, types));</span></span>
			}
			if (Array.isArray(schema.anyOf)) {
				schema.anyOf.forEach(s =&gt; this.addSchemaValueCompletions(s, separatorAfter, collector, types));
			}
			<span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(schema.oneOf)) {
<span class="cstat-no" title="statement not covered" >				schema.oneOf.forEach(<span class="fstat-no" title="function not covered" >s </span>=&gt; <span class="cstat-no" title="statement not covered" >this.addSchemaValueCompletions(s, separatorAfter, collector, types));</span></span>
			}
		}
	}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >					type = 'array';</span>
		...
		if (Array.isArray(schema.defaultSnippets)) {
			schema.defaultSnippets.forEach(s =&gt; {
				...
				if (isDefined(value)) {
				...
				} else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof s.bodyText === 'string') {
					...
					label = label || <span class="branch-1 cbranch-no" title="branch not covered" >insertText,</span>
...
&nbsp;
	private addFillerValueCompletions(types: { [type: string]: boolean }, separatorAfter: string, collector: CompletionsCollector): void {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (types['array']) {
<span class="cstat-no" title="statement not covered" >			collector.add({</span>
				kind: this.getSuggestionKind('array'),
				label: '[]',
				insertText: this.getInsertTextForGuessedValue([], separatorAfter),
...
&nbsp;
	private addDollarSchemaCompletions(separatorAfter: string, collector: CompletionsCollector): void {
		const schemaIds = this.schemaService.getRegisteredSchemaIds(schema =&gt; schema === 'http' || <span class="branch-1 cbranch-no" title="branch not covered" >schema === 'https')</span>;
...
&nbsp;
	private getInsertTextForValue(value: any, separatorAfter: string): string {
		...
		} else <span class="missing-if-branch" title="if path not taken" >I</span>if (text === '[]') {
<span class="cstat-no" title="statement not covered" >			return '[$1]' + separatorAfter;</span>
		}
...
<span class="cstat-no" title="statement not covered" >					return '${1:null}' + separatorAfter;</span>
				}
...
<span class="cstat-no" title="statement not covered" >		return this.getInsertTextForValue(value, separatorAfter);</span>
	}
&nbsp;
	private getSuggestionKind(type: any): CompletionItemKind {
		if (Array.isArray(type)) {
			const array = &lt;any[]&gt;type;
			type = array.length &gt; 0 ? array[0] : <span class="branch-1 cbranch-no" title="branch not covered" >undefined;</span>
		}
		if (!type) {
...
<span class="branch-2 cbranch-no" title="branch not covered" >			case 'property': <span class="cstat-no" title="statement not covered" >return CompletionItemKind.Property;</span></span>
...
&nbsp;
	private getLabelTextForMatchingNode(node: ASTNode, document: TextDocument): string {
		switch (node.type) {
<span class="branch-0 cbranch-no" title="branch not covered" >			case 'array':</span>
<span class="cstat-no" title="statement not covered" >				return '[]';</span>
			case 'object':
				return '{}';
			default:
...
&nbsp;
	private getInsertTextForMatchingNode(node: ASTNode, document: TextDocument, separatorAfter: string): string {
		switch (node.type) {
<span class="branch-0 cbranch-no" title="branch not covered" >			case 'array':</span>
<span class="cstat-no" title="statement not covered" >				return this.getInsertTextForValue([], separatorAfter);</span>
			case 'object':
...
&nbsp;
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!addValue) {
<span class="cstat-no" title="statement not covered" >			return propertyText;</span>
		}
		...
		if (propertySchema) {
			if (Array.isArray(propertySchema.defaultSnippets)) {
				if (propertySchema.defaultSnippets.length === 1) {
					...
					<span class="missing-if-branch" title="else path not taken" >E</span>if (isDefined(body)) {
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(propertySchema.examples) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >propertySchema.examples.length)</span> {
<span class="cstat-no" title="statement not covered" >				if (!value) {</span>
<span class="cstat-no" title="statement not covered" >					value = this.getInsertTextForGuessedValue(propertySchema.examples[0], '');</span>
				}
<span class="cstat-no" title="statement not covered" >				nValueProposals += propertySchema.examples.length;</span>
			}
			if (nValueProposals === 0) {
				var type = Array.isArray(propertySchema.type) ? <span class="branch-0 cbranch-no" title="branch not covered" >propertySchema.type[0] </span>: propertySchema.type;
				if (!type) {
					<span class="missing-if-branch" title="if path not taken" >I</span>if (propertySchema.properties) {
<span class="cstat-no" title="statement not covered" >						type = 'object';</span>
					} else <span class="missing-if-branch" title="if path not taken" >I</span>if (propertySchema.items) {
<span class="cstat-no" title="statement not covered" >						type = 'array';</span>
					}
				}
				switch (type) {
					...
					case 'integer':
						value = '${1:0}';
						break;
<span class="branch-6 cbranch-no" title="branch not covered" >					case 'null':</span>
<span class="cstat-no" title="statement not covered" >						value = '${1:null}';</span>
	...
	private findItemAtOffset(node: ArrayASTNode, document: TextDocument, offset: number) {
		...
		for (let i = children.length - 1; i &gt;= 0; i--) {
			...
			if (offset &gt; child.offset + child.length) {
				...
				const token = scanner.scan();
				<span class="missing-if-branch" title="else path not taken" >E</span>if (token === Json.SyntaxKind.CommaToken &amp;&amp; offset &gt;= scanner.getTokenOffset() + scanner.getTokenLength()) {
					return i + 1;
				}
...
&nbsp;
<span class="fstat-no" title="function not covered" >	private d</span>oesSupportsCommitCharacters() {
<span class="cstat-no" title="statement not covered" >		if (!isDefined(this.supportsCommitCharacters)) {</span>
			const completion = <span class="cstat-no" title="statement not covered" >this.clientCapabilities.textDocument &amp;&amp; this.clientCapabilities.textDocument.completion;</span>
<span class="cstat-no" title="statement not covered" >			this.supportsCommitCharacters = completion &amp;&amp; completion.completionItem &amp;&amp; !!completion.completionItem.commitCharactersSupport;</span>
		}
<span class="cstat-no" title="statement not covered" >		return this.supportsCommitCharacters;</span>
	}
&nbsp;
}
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Apr 27 2020 21:56:17 GMT+0200 (Central European Summer Time)
            </div>
        </div>
