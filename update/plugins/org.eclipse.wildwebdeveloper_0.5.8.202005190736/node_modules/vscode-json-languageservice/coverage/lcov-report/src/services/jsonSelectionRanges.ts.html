...
<head>
    <title>Code coverage report for src/services/jsonSelectionRanges.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/services</a> jsonSelectionRanges.ts</h1>
        <div class='clearfix'>
...
&nbsp;
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!current) {
<span class="cstat-no" title="statement not covered" >			current = SelectionRange.create(Range.create(position, position));</span>
		}
		return current;
	}
&nbsp;
