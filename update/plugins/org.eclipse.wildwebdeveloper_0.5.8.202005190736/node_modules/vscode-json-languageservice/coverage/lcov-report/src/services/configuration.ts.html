...
<head>
    <title>Code coverage report for src/services/configuration.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/services</a> configuration.ts</h1>
        <div class='clearfix'>
...
<a name='L534'></a><a href='#L534'>534</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
for (const schemaName in schemaContributions.schemas) {
	...
	for (const property in schema.properties) {
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (description) {
			propertyObject['description'] = description;
		} else {
<span class="cstat-no" title="statement not covered" >			console.log(`${property}: localize('schema.json.${property}', "")`);</span>
		}
	}
}</pre></td></tr></table></pre>
