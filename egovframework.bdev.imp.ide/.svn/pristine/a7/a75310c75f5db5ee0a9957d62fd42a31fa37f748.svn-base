...
public class NewBatchTemplateProject extends AbstractHandler implements EgovBatchMenu {
	/**
	 * 템플릿 프로젝트 생성 마법사
	 */
	public Object execute(ExecutionEvent event) throws ExecutionException {
		IWizardDescriptor wizardDesc = WorkbenchPlugin.getDefault().getNewWizardRegistry().findWizard("egovframework.bdev.imp.ide.wizards.egovbatchtemplateprojectwizard");
