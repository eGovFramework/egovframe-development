 ...
 * </pre>
 */
public class ComboButtonField extends ComboField {
	 ...
	 * @param buttonText
	 */
	public ComboButtonField(String labelText, String buttonText) {
		super(labelText);
	...
	private void createButton(FormToolkit toolkit, Composite parent,
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				fireFieldEvent(new FieldEvent(FieldEvent.Type.ButtonSelected, ComboButtonField.this));
			}
		});
	}
