 ...
 * </pre>
 */
public class SqlMapAddQueryInsertAction extends SqlMapAddElementAction {
	 ...
	 * @param viewer
	 */
	public SqlMapAddQueryInsertAction(SqlMapPage page, StructuredViewer viewer) {
		super(viewer, "Add Insert Query");
		this.setPage(page);
	}
	...
	protected SqlMapElement createNewElement(Element root) {
		...
		String tagName = "insert"; //$NON-NLS-1$
