 ...
 * </pre>
 */
public class SqlMapAddQueryStatementAction extends SqlMapAddElementAction {
	 ...
	 * @param viewer
	 */
	public SqlMapAddQueryStatementAction(SqlMapPage page, StructuredViewer viewer) {
		super(viewer, "Add Statement Query");
		this.setPage(page);
	}
	...
	protected SqlMapElement createNewElement(Element root) {
		...
		String tagName = "statement"; //$NON-NLS-1$
