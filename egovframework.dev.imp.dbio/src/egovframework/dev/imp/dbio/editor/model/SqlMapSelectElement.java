 ...
 * </pre>
 */
public class SqlMapSelectElement extends SqlMapCRUDElement {
	 ...
	 * @param parent
	 */
	public SqlMapSelectElement(Element element, Object parent) {
	...
	public String getResultClass() {
		return element.getAttribute("resultClass"); //$NON-NLS-1$
	}
	...
	public void setResultClass(String value) {
		if(value == null || value.equals(""))
			element.removeAttribute("resultClass");
		else
			element.setAttribute("resultClass", value); //$NON-NLS-1$
	}
	...
	public void setResultXml(String xmlName) {
		if (xmlName == null || "".equals(xmlName)) {
			...
			element.setAttribute("resultClass", "xml");
