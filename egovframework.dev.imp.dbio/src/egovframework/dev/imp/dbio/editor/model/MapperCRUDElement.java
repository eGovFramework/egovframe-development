 ...
 * </pre>
 */
public class MapperCRUDElement extends MapperElement {
	 ...
	 * @param parent
	 */
	public MapperCRUDElement(Element element, Object parent) {
	...
	public String getParameterClass() {
		return element.getAttribute("parameterType"); //$NON-NLS-1$
	}
	...
	public void setParameterClass(String value) {
		if(value == null || value.equals(""))
			...
			element.setAttribute("parameterType", value); //$NON-NLS-1$
	}
