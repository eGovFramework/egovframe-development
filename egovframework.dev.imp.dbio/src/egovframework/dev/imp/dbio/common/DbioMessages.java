...
public class DbioMessages extends NLS {
	...
	// myBatis
	public static String NewMapperConfigWizardPage_1;
	public static String NewMapperConfigWizardPage_2;
	public static String NewMapperWizardPage_1;
	public static String NewMapperWizardPage_2;
	/** MAPPER 에서 쿼리 ID 중복 체크 오류 메시지 */	
	public static String mapper_err_QueryId_duplication;
	/** MAPPER 에서 ParameterMap ID 중복 체크 오류 메시지 */
	public static String mapper_err_ParameterMapId_duplication;
	/** MAPPER 에서 ResultMap ID 중복 체크 오류 메시지 */
	public static String mapper_err_ResultMapId_duplication;
	/** MAPPER 에서 Alias ID 중복 체크 오류 메시지 */
	public static String mapper_err_AliasName_duplication;
	/** MAPPER 에서 쿼리 ID 공백 오류 메시지 */	
	public static String mapper_err_QueryId_invalid;
	/** MAPPER 에서 ParameterMap ID 공백 오류 메시지 */
	public static String mapper_err_ParameterMapId_invalid;
	/** MAPPER 에서 ResultMap ID 공백 오류 메시지 */
	public static String mapper_err_ResultMapId_invalid;
	/** MAPPER 에서 Alias ID 공백 오류 메시지 */
	public static String mapper_err_AliasName_invalid;
	/** 바인딩 변수 사용 오류 */
	public static String mapper_err_binding_variables;
	/** MAPPER CONFIG 에서 Property Name 중복 오류 메시지 */
	public static String mapperconfig_err_PropertyName_duplication;
	/** MAPPER CONFIG 에서 Property Name 공백 오류 메시지 */
	public static String mapperconfig_err_PropertyName_invalid;
	/** MAPPER CONFIG 에서 Property Value 공백 오류 메시지 */
	public static String mapperconfig_err_PropertyValue_empty;
	/** MAPPER CONFIG 에서 TypeAlias Alias 중복 오류 메시지 */
	public static String mapperconfig_err_TypeAliasAlias_duplication;
	/** MAPPER CONFIG 에서 TypeAlias Alias 공백 오류 메시지 */
	public static String mapperconfig_err_TypeAliasAlias_invalid;
	/** MAPPER CONFIG 에서 TypeAlias Type 공백 오류 메시지 */
	public static String mapperconfig_err_TypeAliasType_empty;
	/**	MAPPER 에서 VO 생성시 테스트를 먼저 수행하라는 메시지 */
	public static String mapper_info_doQueryTest;
	/**	MAPPER 에서 type 안내 메시지 */
	public static String mapper_display_Type_guide;
	// common
