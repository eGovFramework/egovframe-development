 ...
 * </pre>
 */
public class MapperConfigurationTransactionManagerSection extends SectionFactory {
	...
	public MapperConfigurationTransactionManagerSection() {
...
//		}
	...
	public void chkValidation(){ 
		...
		if (getTmElement() != null && getTmElement().hasChildNodes()){
			if (chkPropertyNameValidation( getTmElement(),"property"))
				displayErrorMessage(form,DbioMessages.mapperconfig_err_PropertyName_invalid);
			if (chkPropertyValueEmpty(getTmElement(),"property"))
				displayErrorMessage(form,DbioMessages.mapperconfig_err_PropertyValue_empty);
			if (chkPropertyDuplicate(getTmElement(),"property"))
				displayErrorMessage(form,DbioMessages.mapperconfig_err_PropertyName_duplication);
		}
	}
	...
	public void initErrorMessage(Form form) { 
		...
		if (message!=null){
			message = message.replaceAll(DbioMessages.mapperconfig_err_PropertyName_duplication,"");
			message = message.replaceAll(DbioMessages.mapperconfig_err_PropertyName_invalid,"");
			message = message.replaceAll(DbioMessages.mapperconfig_err_PropertyValue_empty,"");
			if (message.length()==0)
