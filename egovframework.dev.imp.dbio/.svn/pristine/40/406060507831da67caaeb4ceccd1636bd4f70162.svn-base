 ...
 * </pre>
 */
public class MapperAction extends BaseSelectionListenerAction {
	 ...
	 * @param text
	 */
	public MapperAction(StructuredViewer viewer, String text) {
		super(text);
		//this.viewer = viewer;
	 ...
	 * @param selection
	 */
	public void refreshViewer(MapperGroupElement group, ISelection selection) {
	...
	protected void resetGroups() {
		for (Object group : getGroups()) {
			((MapperGroupElement) group).reset();
		}
	}
