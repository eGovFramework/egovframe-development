		...
		int result = 1;
			...
			if(ssm.getCreateStatement() != null){
				...
				try {
					...
					if(result  == 0){
						ssm.setSucceed(true);
						ssm.setResultMessage(MobileComMngtMessages.executeSQLUtilresult1);
						
					}else{
						ssm.setSucceed(true);
						ssm.setResultMessage(MobileComMngtMessages.executeSQLUtilresult2);
					}
...
//					MobileComMngtLog.logError(e);
					...
					ssm.setResultMessage(MobileComMngtMessages.executeSQLUtilresult3);
				}
