 ...
 */
package egovframework.mdev.imp.commngt.common;
...
public class MobileComMngtLog {
    ...
    private static IStatus createStatus(int severity, int code, String message,
            Throwable exception) {
        IStatus status =
            new Status(severity, MobileComMngtPlugin.PLUGIN_ID, code, message,
                exception);
        return status;
    }
    ...
    private static void log(IStatus status) {
    	MobileComMngtPlugin.getDefault().getLog().log(status);
        return;
    }
