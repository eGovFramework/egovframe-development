...
/**
 * mobileOk 사이트의 File Upload 단위 검증 페이지를 오픈하는  클래스
 * @author 이혜린
 * @since 2011.07.20
 * @version 1.0
 * @see <pre>
 ...
 * </pre>
 */
public class OpenMobileOkByFile extends AbstractHandler {
	
	/**
	 * The constructor.
	 */
	public OpenMobileOkByFile() {
	}
	
    /**
     * 이클립스 내부 browser로 mobeliOk 사이트의 File Upload 방식 검증 페이지 실행
     */
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			browser = browserSupport.createBrowser("OpenMobileOkByFile");
			browser.openURL(new URL("http://v.mobileok.kr/index_file.jsp"));
