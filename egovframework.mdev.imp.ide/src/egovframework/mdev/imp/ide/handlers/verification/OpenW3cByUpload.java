...
/**
 * W3C 사이트의 Upload방식 소스검증 페이지를 오픈하는  클래스
 * @author 이혜린
 * @since 2011.07.20
 * @version 1.0
 * @see <pre>
 ...
 * </pre>
 */
public class OpenW3cByUpload extends AbstractHandler {
	
	/**
	 * The constructor.
	 */
	public OpenW3cByUpload() {
	}
	
	/**
     * 이클립스 내부 browser로 W3C 사이트의 Upload 방식 소스검증 페이지 실행
     */
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			browser = browserSupport.createBrowser("OpenW3cByUpload");
			browser.openURL(new URL("http://validator.w3.org/#validate_by_upload"));
