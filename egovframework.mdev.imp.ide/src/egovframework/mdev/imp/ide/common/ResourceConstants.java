...
public class ResourceConstants {
    ...
    /** 테스트 리소스 폴더 */
    public static final IPath TEST_RESOURCE_FOLDER = new Path("src/test/resources"); 

    /** META-INF 경로 */
    public static final IPath METAINF_PATH = new Path("src/main/webapp/META-INF"); 
    /** WEB-INF 경로 */
    public static final IPath WEBINF_PATH = new Path("src/main/webapp/WEB-INF/"); 
    /** WEB-INF/lib 경로 */
    public static final IPath WEBINF_LIB_PATH = new Path("src/main/webapp/WEB-INF/lib"); 
    /** WEB-INF/classes 경로 */
    public static final IPath WEBINF_CLASSES_PATH = new Path("src/main/webapp/WEB-INF/classes"); 

    /** 기본 output 폴더 */
    public static final IPath DEFAULT_OUTPUT_FOLDER = new Path("target/classes"); 
    /** 테스트 output 폴더 */
    public static final IPath TEST_OUTPUT_FOLDER = new Path("target/test-classes"); 
    ...
    /** POM 예제 파일 경로 */
    public static final String POM_EXAMPLE_PATH = "egovframework/mdev/imp/ide/wizards/examples/"; 
    /** 예제 파일 경로 */
