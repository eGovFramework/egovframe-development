...
/**
 * Moblie eGovFramework 프로젝트 생성 마법사 페이지 기반 추상 클래스
 * @author 이종대
 * @since 2011.07.13
 * @version 1.0
 * @see <pre>
...
public abstract class MobileBaseProjectCreationPage extends WizardPage {
     ...
     * @param pageName
     */
    public MobileBaseProjectCreationPage(String pageName) {
        super(pageName);
    ...
    private final void createProjectNameGroup(Composite parent) {
        ...
        projectLabel.setText(MoblieIdeMessages.wizardsPagesBaseMProjectCreationPage5);
    ...
    private final void createProjectLocationGroup(Composite parent) {
        ...
        group.setText(MoblieIdeMessages.wizardsPagesBaseMProjectCreationPage0);
        ...
        useDefaultWorkspaceLocationButton.setText(MoblieIdeMessages.wizardsPagesBaseMProjectCreationPage1);
        ...
        locationLabel
            .setText(MoblieIdeMessages.wizardsPagesBaseMProjectCreationPage2);
        ...
        locationBrowseButton
            .setText(MoblieIdeMessages.wizardsPagesBaseMProjectCreationPage3);
        locationBrowseButton.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                DirectoryDialog dialog = new DirectoryDialog(getShell());
                dialog
                    .setText(MoblieIdeMessages.wizardsPagesBaseMProjectCreationPage4);
	...
	protected boolean validatePage() {
        ...
        if(!Pattern.matches("^[a-zA-Z0-9-._]*$", projectName) || projectName.indexOf("`")>-1 || projectName.indexOf("^")>-1|| projectName.indexOf("\\")>-1) { //$NON-NLS-1$
        	setErrorMessage(MoblieIdeMessages.mobileBaseProjectCreationPage3);
        	return false;
        }
        
        if(projectName.length() > 165) {
        	setErrorMessage(MoblieIdeMessages.mobileBaseProjectCreationPage5);
        	return false;
        }
...
//        }
        ...
        if (project.exists()) {
            setErrorMessage(MoblieIdeMessages.mobileBaseProjectCreationPage0); 
            return false;
        }
...
//            setErrorMessage(validLocationMessage);
            setErrorMessage(MoblieIdeMessages.mobileBaseProjectCreationPage1);
            return false;
        }
    ...
    public String checkValidProjectLocation(IProject existingProject) {
        ...
        if (locationFieldContents.length() == 0) {
            return MoblieIdeMessages.mobileBaseProjectCreationPage6;
        }
