...
//		return new NewDeviceAPIWebProjectCreationOperation2(getContext());
	}

	@Override
	public void addPages() {
//		Device API 프로젝트 생성페이지 제거
//		createPage = new DeviceAPIProjectNewCreationPage("CreatePage", context);
//		addPage(createPage);

//		Device API Template 생성페이지 제거
...
//		addPage(generateTemplatePage);
		...
		createWebPJT = new DeviceAPIWebProjectCreationPage("createWebPJT", context);
