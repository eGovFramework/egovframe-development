...
public class ProjectCreationPage extends BaseProjectCreationPage {
    ...
    private void createMavenSettingGroup(Composite container) {
        ...
        mavenGroup.setText(IdeMessages.wizardspagesProjectCreationPage14);
        ...
        groupIdText =
            IdeUIUtil.createTextField(mavenGroup,
                IdeMessages.wizardspagesProjectCreationPage15);
        ...
        artifactIdText =
            IdeUIUtil.createTextField(mavenGroup,
                IdeMessages.wizardspagesProjectCreationPage16);
        ...
        versionCombo =
            IdeUIUtil.createComboField(mavenGroup,
                IdeMessages.wizardspagesProjectCreationPage17);
    ...
    protected boolean validatePage() {
        ...
        if ("".equals(getProjectName())) {  //$NON-NLS-1$
        	setErrorMessage(IdeMessages.projectCreationPage7);
        	return false;
        }
        ...
        if ("".equals(getArtifactId())) {  //$NON-NLS-1$
        	setErrorMessage(IdeMessages.wizardspagesProjectCreationPage13);
        	return false;
        }
