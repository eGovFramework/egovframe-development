...
public class IdeMessages extends NLS {
    ...
    /** 새로워진 50종 공통컴포턴트  프로젝트 타이틀 */
    public static String wizardspagesTemplateProjectCreationPage13;
    /** 새로원지 50종 공통컴포넌트 프로젝트 내용 */
    public static String wizardspagesTemplateProjectCreationPage14;
