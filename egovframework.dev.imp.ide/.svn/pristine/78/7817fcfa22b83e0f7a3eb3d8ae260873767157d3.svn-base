...
public class ExampleInfo {
    ...
    /** 새로워진 50종 공통컴포넌트 POM 파일 */
    public static String newcommonPomFile;
    ...
    /** 새로워진 50종 공통컴포넌트 예제*/
    public static String templateNewCommonAllInOneExample;
    ...
    static {
        try {
            ...
            newcommonPomFile = resource.getString("pom.newcommon");
            ...
            templateNewCommonAllInOneExample = resource.getString("example.template.newcommon");
