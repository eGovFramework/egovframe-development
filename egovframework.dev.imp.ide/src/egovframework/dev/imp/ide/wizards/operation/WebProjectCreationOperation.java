 ...
 * </pre>
 */
public class WebProjectCreationOperation extends ProjectCreationOperation {

	/**
	 * 생성자
	 * @param context
	 */
	public WebProjectCreationOperation(NewProjectContext context) {
		super(context);
	}
	...
	protected void configureClasspath(IProgressMonitor monitor) throws CoreException {
		...
		IdeUtils.assignClasspathEntryToJavaProject(getProject(), classpathEntrys, true);
