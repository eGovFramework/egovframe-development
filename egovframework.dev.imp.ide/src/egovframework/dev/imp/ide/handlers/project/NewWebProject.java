...
public class NewWebProject extends AbstractHandler implements EgovMenu {
	/**
	 * 웹 프로젝트 생성 마법사 실행
	 */
	public Object execute(ExecutionEvent event) throws ExecutionException {
		IWizardDescriptor wizardDesc = WorkbenchPlugin.getDefault().getNewWizardRegistry().findWizard("egovframework.dev.imp.ide.wizards.egovwebprojectwizard");
