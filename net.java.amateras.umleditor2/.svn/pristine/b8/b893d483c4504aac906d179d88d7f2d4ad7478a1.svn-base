...
public class MessageTextCellEditor extends TextCellEditor {
	...
	protected Control createControl(final Composite parent) {
		...
		TextContentAssistSubjectAdapter adapter = new TextContentAssistSubjectAdapter(text);
	...
	class ContentAssistProcessor implements ISubjectControlContentAssistProcessor {
