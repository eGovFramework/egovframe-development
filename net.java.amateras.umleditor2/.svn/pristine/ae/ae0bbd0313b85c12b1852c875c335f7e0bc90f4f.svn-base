...
public class InstanceEditPart extends AbstractUMLEntityEditPart {
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new InstanceNodeEditPolicy());
	}

	public void propertyChange(PropertyChangeEvent evt) {
		if (evt.getPropertyName().equals(InstanceModel.P_NAME) || evt.getPropertyName().equals(InstanceModel.P_TYPE)) {
			refreshName();
		}
	...
	public ConnectionAnchor getTargetConnectionAnchor(ConnectionEditPart connection) {
		...
		if (model instanceof SyncMessageModel) {
			return new InstanceIncomingConnectionAnchor(getFigure(), model.getSource());
		}
		return null;
	}
	...
	private class CreateCompleteCommand extends ConnectionCommand {
		...
		public void execute() {
			...
			Rectangle newRect = new Rectangle(actP, new Dimension(ActivationModel.DEFAULT_WIDTH, ActivationModel.DEFAULT_HEIGHT));
