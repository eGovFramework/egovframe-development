 ...
 *
 */
public class ReturnMessageOutgoingAnchor extends AbstractConnectionAnchor {


	private AbstractUMLEntityModel relation;
	
	
	public ReturnMessageOutgoingAnchor(IFigure owner, AbstractUMLEntityModel relation) {
		super(owner);
	...
	public Point getLocation(Point reference) {
		...
		point.y = point.y + getOwner().getBounds().height;
