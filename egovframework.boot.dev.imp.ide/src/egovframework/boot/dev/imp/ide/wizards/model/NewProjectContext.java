 ...
 */
package egovframework.boot.dev.imp.ide.wizards.model;
...
public class NewProjectContext extends NewWebProjectContext{
    ...
    /** 템플릿 프로젝트 생성 상위 타이틀 */
    private String templateProjectTopTitle;
	...
	//getter
    public String getTemplateProjectTopTitle() {
		return templateProjectTopTitle;
	}
    //setter
	public void setTemplateProjectTopTitle(String templateProjectTopTitle) {
		this.templateProjectTopTitle = templateProjectTopTitle;
	}
	//getter
