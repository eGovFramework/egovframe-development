...
/**
 * 프로젝트 생성 마법사 페이지 클래스 for Boot Web Project
 * @author 개발환경 개발팀 이흥주
 * @since 2009.06.01
 * @version 1.0
 * @see <pre>
 ...
 * </pre>
 */
public class ProjectCreationPage extends BaseProjectCreationPage {
     ...
     * @param context
     */
    protected ProjectCreationPage(String pageName, NewProjectContext context) {
        super(pageName);
    ...
    private void createMavenSettingGroup(Composite container) {
        ...
        mavenGroup.setText(BootIdeMessages.wizardspagesProjectCreationPage14);
        ...
        groupIdText =
            IdeUIUtil.createTextField(mavenGroup,
            		BootIdeMessages.wizardspagesProjectCreationPage15);
        ...
        artifactIdText =
            IdeUIUtil.createTextField(mavenGroup,
            		BootIdeMessages.wizardspagesProjectCreationPage16);
        ...
        versionCombo =
            IdeUIUtil.createComboField(mavenGroup,
            		BootIdeMessages.wizardspagesProjectCreationPage17);
    ...
    protected boolean validatePage() {
        ...
        if ("".equals(getArtifactId())) {  //$NON-NLS-1$
        	setErrorMessage(BootIdeMessages.wizardspagesProjectCreationPage13);
        	return false;
        }
