...
<!--
  ...
  Requirements:
  - Ehcache 3.x
  - Spring Framework 6.x with JCache (JSR-107)
  - Jakarta EE 9+
  - JDK 17+
-->
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="jCacheCacheManager" class="org.springframework.cache.jcache.JCacheManagerFactoryBean">
        <property name="cacheManagerUri" value="classpath:/ehcache-default.xml" />
        <property name="cachingProvider">
            <bean class="org.ehcache.jsr107.EhcacheCachingProvider" factory-method="getInstance" />
        </property>
    </bean>
    ...
    Note: /ehcache-default.xml 경로의 파일은 Ehcache 3.x XML 형식이어야 합니다.
    -->
